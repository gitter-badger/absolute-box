...
$( ".YOUR-CLASS" ).absoluteBoxPlugin( {
	...
	settings: {
		...
		//The plug-in creates new dom elements that are selected through a data-attribute.
		//If you encounter a conflict with this name, you can change it here.
		dataName: "absolutebox",

		//TRUE or FALSE when true means that you agree to show the picture caption
		//(it works only with figure tags) and false (of course) that you don't want this feature.
		figcaption: true,

		//TRUE or FALSE when true means that you agree to show the permalink of picture.
		//(It works for all pictures selected) and false (of course) not.
		permalink: true
	},

	//From here on there is only the style. Be careful to override this feature.
	//These are the defaults value. You can play with them and customize them as you like.
	//
